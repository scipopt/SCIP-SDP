...
we also use three types of scaled matrices with theoretical results on their restricted isometry
...
The restricted isometry constants of all matrices can be found in the appendix. Note that for the unscaled matrices,
the restricted isometry constants can be expected to be much larger than for the scaled ones. Even for the scaled
matrices, the restricted isometry property did not hold for any of the matrices in the testset, since the instances
were too small to satisfy the needed relation between $n$ and $k$.
\color{red} Furthermore, since we solved
...
of about $10^{-2}$ for the unscaled matrices, while the precision is much better for the normalized ones because of their
