...
a time limit of four hours. The code was compiled with gcc 4.4.5 with \texttt{-O3} optimization. For 39 matrices and all 15 choices of $\rho$,
the evaluation of~\eqref{Asp08Dual} was aborted because of the memory limit of 8GB. These are counted with the maximum allowed time of four hours. 
