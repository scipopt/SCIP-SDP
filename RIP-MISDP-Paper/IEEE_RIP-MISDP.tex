...
improve the bounds computed with the semidefinite relaxations proposed in \cite{Asp08} and \cite{Asp07}, but this comes at the cost of a much higher complexity of computation, at least in comparison to \cite{Asp07}. We could only 
