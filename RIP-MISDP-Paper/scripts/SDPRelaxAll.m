function [ A ] = SDPRelaxAll( m,n,k,option,p,r,MatrixFile, RIPlFile, RIPrFile, Aspr07lFile, Aspr07rFile, nullspaceContFile, RIPlZPLFile, RIPrZPLFile, nullspaceZPLFile)
...
fclose(fid);
if RIPlFile ~= ' '
    RIPSDPA(A,k,'l',RIPlFile,0);
end
if RIPrFile ~= ' '
    RIPSDPA(A,k,'r',RIPrFile,0);
end
if Aspr07lFile ~= ' '
