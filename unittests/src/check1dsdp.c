...
Test(checksdpi, test1)
{
   ...
   SCIP_CALL( SCIPsolveOneVarSDP(buffermem, obj, lb, ub, 2, 1, sdpconstrow, sdpconstcol, sdpconstval, 1, sdprow, sdpcol, sdpval, 1e20, EPS, EPS, &objval, &dualsol) );
...
Test(checksdpi, test4)
{
   ...
   /* directly solve problem */
   SCIP_CALL( SCIPsolveOneVarSDP(buffermem, obj, lb, ub, 2, 3, sdpconstrow, sdpconstcol, sdpconstval, 3, sdprow, sdpcol, sdpval, 1e20, EPS, EPS, &objval, &dualsol) );
