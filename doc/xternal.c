 ...
 *
 * @version 4.0.0
 * @author Tristan Gally, Frederic Matter, Marc Pfetsch; Sonja Mars, Lars Schewe
 * @date 2011-2021
 *
 ...
 * <tr><td>relaxing/SDP/peninfeasadjust = 10</td> <td>increase numerical stability by only allowing cutoffs through the penalty formulation if the objective value of the feasilibity problem is at least this factor larger than the gap- and feasibility tolerance</td></tr>
