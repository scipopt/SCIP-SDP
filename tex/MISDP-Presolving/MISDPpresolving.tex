...
\begin{remark}
  Most likely this can be generalized to the more interesting case of a
  ...
  \ell \leq (x,t) \leq u,
\]
where~$t$ is a scalar variable. Since constraints of this particular form
appear in truss topology design and cardinality least-squares problems, we
should check whether this helps for such instances.
\end{remark}
