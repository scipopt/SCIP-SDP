...
\begin{proof}
  ...
  identity matrices to $M$, which do not change the property of being TU.
\end{proof}
...
\begin{remark}
  ...
  \begin{align*}
    ...
    & \sum_{i=1}^t x_i \geq \sum_{i=1}^t D_i\quad \forall i = 1, \dots, n - 1,\\
    & \sum_{i=1}^n x_i = \sum_{i=1}^n D_i,\\
    & 0 \leq x \leq M z,\\
    & z \in \{0,1\}^n.
  \end{align*}
  If $D_i = 0$, $i = 1, \dots, n-1$, $D_i = 1$, and $M = 1$, we obtain our problem.
