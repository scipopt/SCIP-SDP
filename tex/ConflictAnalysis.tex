...
\begin{lemma}\label{lemma:ComplemenatrySolution}
  ...
  there exists $r^\ell$, $r^u \in \R^m_+$ with $r^\ell - r^u = s$, such
...
\begin{proof}
  ...
  $j \in [m]$ and $r^\ell - r^u = s$. Then consider:
  \begin{align*}
...
\begin{proof}
  ...
  in~\eqref{eq:ray} is still statisfied. We thus obtain
  \begin{align*}
...
cancellation to continuous variables, but restricts attention to variables
